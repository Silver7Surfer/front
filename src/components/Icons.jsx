...
export const BitcoinIcon = ({ size = 24, className = "" }) => (
  ...
  export const LightningIcon = ({ size = 24, className = "" }) => (
    <svg 
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M11 15H6.414l4.293-4.293A1 1 0 0 0 11 9.586V5.414l4.293 4.293A1 1 0 0 1 15 11.414V19l-7-7h2v3zm0-10V2L3 14h7v5l9-9h-7V5z" />
    </svg>
  );